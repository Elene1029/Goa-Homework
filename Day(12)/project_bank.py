...
meli = ("<  MELI : 32 to 55 REGISTRATION. >")                           
print(meli)
george = ("<  GEORGE :  The old transaction code consisted of 70 lines an51 letters while the new one consisted of  and 820 lines75 letters  102 to 122 >")
george_and_david = ("<  GEORGE AND DAVID : Davit built the skeleton  and Georgie optimized it the kode.  >")
print(george_and_david)
print(george)
david = ("<  DAVID : 59 to 99  and 102 to 122  Did the friend chat as well as the balance putting money in the balance and withdrawing money from the balance>")
print(david)
elene = ("<  ELENE : I gathered the group, helped the maximum, added comments, beauty and description of the project  and  129 to 182 He made it so that the customer in the bank could choose the questions and what each question meant>")
print(elene)
